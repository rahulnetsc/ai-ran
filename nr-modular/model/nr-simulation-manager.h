...
class NrSimulationManager : public Object
{
  public:
    ...
    Ptr<NrNetworkManager> GetNetworkManager() const;
    ...
    // TBD : Add methods for sampling channel conditions, etc. at (x,y,z,t) druing simulation
    // TBD : Add methods for dynamic updation of gNB RF signal boundaries during simulation
